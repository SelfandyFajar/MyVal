var particleBackground = {
    ...
    snowflakes1: [],
    snowflakes2: [],
    snowImage1: 'http://iconshow.me/media/images/xmas/christmas-icons/7/snowflake-512.png',
    snowImage2: 'http://skirejser-contamines.dk/wp-content/uploads/2015/05/snowflake-blue.pn',
    maxSnow: 50, 
    snowScale: 0.2,
    heartHeight: 40,
    heartWidth: 40,
    hearts: [],
    heartImage: 'https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678087-heart-128.png',
    maxHearts: 14,
    minScale: 0.4,
    draw: function() {
      this.setCanvasSize();
